...
export default class ImportGherkinButton extends React.Component {
  render() {
    return (
      <span className="import-gherkin-input">
        <ImportGherkinInput
          onFileSelected={this.props.onFileSelected}
          labelMarkup={<i className="btn-action si-import-gherkin" />}
...
export class ImportGherkinInput extends React.Component {
  constructor(props) {
    super(props)
    this.id = uuidv4()
    ...
    return (
      <React.Fragment>
        ...
        <label
          ...
          data-tip={`<p>Import Gherkin file <span style="color: #929292;padding-left: 5px;">${parse(
            'g',
